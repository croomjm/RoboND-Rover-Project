...
# Define a function to rotate rover space pixels to world space
...
# Define a function to translate rover space pixels to world space
...
# to map rover-centric pixels to world pixels
...
def perception_step(Rover):
    ...
    # 7) Update Rover.vision_image (unwarped, segmented image)
    # Note that the trust radius is not reflected here
